...
if __name__ == "__main__":
    ...
    async def test_realtime_playback():
        ...
        audio_player = SoundDeviceAudioPlayer(
            ...
            buffer_size=2048,  # 增大 sounddevice 缓冲区
            min_buffer_samples=4800  # 200ms 的预缓冲
        )
        ...
        async def audio_consumer():
            ...
            try:
                ...
                # 打印缓冲区统计信息
                buffer_info = audio_player.get_buffer_info()
                print(f"[Test] Final buffer stats: {buffer_info}")
